...
import com.nttdata.dtl.model.provider.ProviderQuery;
import com.nttdata.dtl.model.provider.ProviderQueryRepository;
    ...
    private Optional<ProviderQuery> getQuery(String provider, String query) {
        ...
        if (optionalProvider.isPresent()) {
            try {
                ...
                return providerQueryRepository.findById(queryId);
